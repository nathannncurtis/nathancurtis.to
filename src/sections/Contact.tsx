...
const links = [
  { label: "Email", value: "nathan@nathancurtis.to", href: "mailto:nathan@nathancurtis.to", icon: MailFilledIcon },
  { label: "GitHub", value: "nathannncurtis", href: "https://github.com/nathannncurtis", icon: GithubIcon },
];
