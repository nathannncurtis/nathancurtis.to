  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        >
          Systems programming, internal tools, and the infrastructure around them. Most of my work lives in private repos for environments where nothing talks to anything else.
        </motion.p>
        ...
        >
          ...
          >
            ...
            Get in touch
            <ArrowNarrowRightIcon size={14} className="transition-transform duration-200 group-hover:translate-x-1" />
          </MagneticLink>
          <MagneticLink
